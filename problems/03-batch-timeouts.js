...
//Base case: callbacks.length === 0
  //return newArr

//Recursive step: arr.slice callbacks and delays to the newArr
//Recursive case: pushing the sliced item from callbacks and delays to the newArr
